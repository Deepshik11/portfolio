...
const Admin = () => {
  ...
  // Prepare visitor data for line chart (monthly)
  const monthlyData = [];
  const countsByMonth = {};
  visitors.forEach((v) => {
  ...
  // Prepare visitor data for pie chart (overall visitors by section)
  const countsBySection = {};
  visitors.forEach((v) => {
    countsBySection[v.section] = (countsBySection[v.section] || 0) + 1;
  });

  const pieData = Object.entries(countsBySection).map(([section, count]) => ({
    name: section,
    value: count,
  }));
  ...
  const COLORS = [
    ...
    "#843c39", "#7b4173", "#5254a3", "#6b6ecf", "#9c9ede", "#ad494a",
    "#a55194", "#636363"
  ];
  ...
  return (
    <>
      <Navbar variant="dark" expand="lg" className="shadow-sm px-3">
        <Container fluid>
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <Dropdown align="end">
              <Dropdown.Toggle variant="outline-light" id="dropdown-user" className="d-flex align-items-center border-0">
      ...
      <div className="shadow rounded-xl p-6 mb-10">
        ...
        <div className="row cu_con d-flex justify-content-around justify-content-md-center justify-content-xl-start m-5 gap-5 mb-5">
          {projects.length === 0 ? (
            ...
            projects.map((project) => (
              ...
              >
                ...
                <div className="card-body p-2">
                  <h5 className="card-title px-2 mt-2 fw-bold" style={{ color: "white" }}>
                    {project.name || "Untitled Project"}
                  </h5>
                  <p className="card-text px-2 mt-3" style={{ color: "white", fontSize: "16px" }}>
                  ...
                  <button onClick={() => handleDelete(project._id)} className="btn btn-danger ms-2 mt-4">
                    Delete
                  </button>
                </div>
              </NavLink>
