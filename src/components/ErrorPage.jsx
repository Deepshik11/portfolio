    ...
    <>
      <div className="row m-0 align-items-center justify-content-center vh-100">
        <div className="col-12 col-sm-8 col-lg-6 d-flex flex-column align-items-center justify-content-center p-3">
          ...
          <h1 className="h3 head text-center mb-2">We Can't find the page you're looking for.</h1>
          <p className="text-center text-white mb-4">Page not found.It may have been moved,renamed, or temporarily unavailable. <br />Please check the URL or go back home.</p>
